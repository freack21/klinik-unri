<div>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800 uppercase">Kelola Profile</h2>
                ...
                <tbody>
                    @foreach ($profiles as $index => $item)
                        <tr class="border-b border-gray-700 hover:bg-gray-700 transition">
                            <td class="py-3 px-4 text-center">{{ $profiles->firstItem() + $index }}</td>
                            <td class="py-3 px-4">{{ $item->title }}</td>
                            <td class="py-3 px-4">{{ Str::limit($item->body, 50) }}</td>
