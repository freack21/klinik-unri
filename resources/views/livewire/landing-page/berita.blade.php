<div class="min-h-screen pt-8">
        ...
        <div class="max-w-7xl mx-auto px-6 mt-12">
            ...
            <div class="relative mt-6" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div class="absolute bottom-8 left-10 right-10 text-white">
                    ...
                    <a href="{{ route('landingpage.lihat-berita', ['id' => $headNews['id']]) }}"
                        class="inline-block mt-6 px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-full transition">
                        Baca Selengkapnya
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 my-16">
            ...
            <div class="grid md:grid-cols-3 gap-6 mt-8">
                ...
                @foreach ($latestNews as $index => $news)
                    <a href="{{ route('landingpage.lihat-berita', ['id' => $news['id']]) }}"
                        class="bg-white rounded-3xl shadow-md hover:shadow-lg transition duration-200 hover:scale-105 hover:shadow-gray-500"
                        data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                        <img src="{{ asset($news['gambar']) }}" class="w-full h-48 object-cover rounded-2xl">
    ...
    @else
        <div class="max-w-7xl mx-auto px-6 mt-12 text-center py-20">
            <div class="flex flex-col items-center justify-center">
                <x-heroicon-o-newspaper class="w-24 h-24 text-gray-300 mb-4" />
                <h2 class="text-2xl font-bold text-gray-600">Belum ada berita yang tersedia saat ini.</h2>
