<div class="min-h-screen pt-8">
    ...
    <div class="max-w-7xl mx-auto px-6 mt-8 grid md:grid-cols-3 gap-6">
        ...
        @foreach (array_slice($berita, 0, 3) as $news)
            <a href="{{ route('landingpage.lihat-berita', ['id' => $news['id']]) }}" class="bg-white rounded-3xl shadow-md hover:shadow-lg transition duration-200 hover:scale-105 hover:shadow-gray-600">
    ...
    <div class="max-w-7xl mx-auto px-6 mt-12 space-y-6">
        ...
        @foreach ($berita as $news)
            <a href="{{ route('landingpage.lihat-berita', ['id' => $news['id']]) }}" class="bg-white rounded-3xl shadow-md overflow-hidden flex flex-col md:flex-row hover:shadow-gray-600 hover:translate-x-1 transition duration-200">
                <img src="{{ asset($news['gambar']) }}"
